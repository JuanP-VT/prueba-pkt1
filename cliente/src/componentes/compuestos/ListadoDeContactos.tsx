    ...
    <div className="w-full flex justify-center flex-col">
      ...
      {data && (
        <div className="w-full flex justify-center flex-col items-center">
          <div className="flex justify-center w-full gap-3 p-5">
          ...
          <div className="flex flex-col sm:grid md:grid-cols-2 gap-5">
          ...
          {contactosFiltrados.length === 0 && (
            <p className="text-center py-5">No se encontraron contactos</p>
          )}
          <div>
            <Stack spacing={2}>
              <Pagination
